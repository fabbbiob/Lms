...
SECRET_KEY="10293802948abcabaacbacbacbabefeacbef"
os.environ.setdefault("SECRET_KEY", SECRET_KEY)
os.environ.setdefault("DEBUG", "True")
os.environ.setdefault("TYPEKIT_URL", 'http://use.typekit.com/example.js')
os.environ.setdefault("SITE_ID", "1")
os.environ.setdefault("FACEBOOK_APP_ID", "1234567890")
os.environ.setdefault("FACEBOOK_API_SECRET", "abc1234567890cba")
...
DATABASES = {'default': dj_database_url.config(default='sqlite:////temp//db//djlms.sqlite')}
